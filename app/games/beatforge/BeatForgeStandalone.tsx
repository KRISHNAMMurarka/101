...
export default function BeatForgeStandalone() {
  ...
  return <main className="site-shell"><BeatForgeGame sessionId={SESSION_ID} onConnect={() => window.open(`/controller?session=${SESSION_ID}`, "_blank", "noopener,noreferrer")} onExit={() => { window.location.href = "/games/beatforge"; }} /></main>;
}
